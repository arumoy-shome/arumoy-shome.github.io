...
The following visualisation comes from the very first Conference paper I wrote [@shome2022data]. The paper explored the presence of anti-patterns in popular ML datasets that lead to accumulation of technical debt in the downstream stages of the pipeline.
...
![Joint distribution of two categorical variables.](jointplot-data-smells.png)

# Heatmap of Correlation Between Numerical Variables

::: {.wide}
![Heatmap of correlation between numerical variables](heatmap-corr.png)
:::

The next visualisation comes from our @shome2024data paper. Here we analysed the relationship between data dependent and model dependent fairness metrics. The heatmap above shows the results obtained from the empirical study conducted using 8 datasets and 4 ML models.
